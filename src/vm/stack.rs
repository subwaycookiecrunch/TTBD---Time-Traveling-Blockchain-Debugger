use crate::core::{VmError, VmResult, U256};
...
impl Stack {
    ...
    // unchecked versions for hot paths

    /// SAFETY: caller must ensure len >= 1
    #[inline(always)]
    ...
    /// SAFETY: caller must ensure len >= 2
    #[inline(always)]
    ...
    /// SAFETY: caller must ensure len < MAX_STACK_SIZE
    #[inline(always)]
